		...
		<div class="space-y-0">
			{#each projects as project}
				<a
					...
					class="flex items-center justify-between border border-warm-700/50 -mt-px first:mt-0 hover:border-warm-600 hover:bg-surface-raised/50 transition-all duration-200 px-6 py-5 no-underline"
				>
